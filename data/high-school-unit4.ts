...
// Confirmed: All 'examples' fields are already in array format.
export const highSchoolUnit4: VocabularyWord[] = [
  ...
  // Page 26
  {
    ...
    usageNotes: [
        ...
        "Takes a direct object without a preposition: resemble sb./sth."
        ],
  },
  {
    word: "typhoon",
  ...
  {
    word: "decrease",
    pronunciation: "/ 'diːkriːs / n. / dɪ'kriːs / v.",
    partOfSpeech: "n./v.",
  ...
  // Page 27
  {
    ...
    definition: "似乎,好像",
    wordRootMemory: "",
    examples: ["It seems cruel not to give some money to beggars. 不给乞丐点钱似乎很残忍。", "I seem to hear a voice in the distance. 我好像听到远处有说话声。", "It seems that she's gone away. 她好像已经走了。", "It seemed as if no one cared. 看起来好像没人在意。", "He seems like a nice guy. 他看上去像是个不错的家伙。"],
    usageNotes: [
  ...
  },
  {
    ...
    definition: "规则的;经常的",
    wordRootMemory: "",
    examples: ["the train's regular schedule 火车的常规时刻表", "He makes regular visits to his parents. 他定期去看望父母。"],
    usageNotes: [
        "regular customer 常客",
        "regular basis 定期地",
  ...
  },
  {
    ...
    examples: ["My parents were in Europe on their fiftieth wedding anniversary. 我父母在欧洲度过了他们的结婚50周年纪念日。", "Today is the anniversary of their first date. 今天是他们第一次约会的周年纪念日。"],
    usageNotes: [
  ...
  },
  {
    ...
    definition: "燃料",
    wordRootMemory: "",
    examples: ["Gas and coal are fuels. 煤气和煤都是燃料。", "The car ran out of fuel. 汽车没油了。"],
    usageNotes: [
  ...
  },
  {
    ...
    definition: "海峡",
    wordRootMemory: "",
    examples: ["Crossing the strait alone is dangerous. 独自穿越海峡很危险。", "The ship sailed through the strait. 轮船驶过海峡。"],
    usageNotes: [
  ...
  },
  {
    ...
    definition: "立方体",
    wordRootMemory: "",
    examples: ["Add two ice cubes to the drink. 在饮料里加两块冰块。", "3 cubed (3³) is 27. 3的立方是27。"],
    usageNotes: [
  ...
  },
  {
    ...
    wordRootMemory: "",
    examples: ["The lamp hung over the table. 那盏灯悬挂在桌子上方。", "Do you think it's going to rain over the weekend? 你认为周末会一直下雨吗?", "The meeting is over. 会议结束了。"],
    usageNotes: [
        "1. all over 浑身; 全部",
  ...
  },
  {
    ...
    examples: ["The boss was always considerate towards every employee. 那个老板总是为每个员工着想。", "It was considerate of you to bring flowers. 你带花来真是太体贴了。"],
    usageNotes: [
  ...
  // Page 28
  {
    ...
    wordRootMemory: "",
    examples: ["Can you speak English? 你会讲英语吗?", "She spoke quietly. 她轻声说话。", "He spoke about his travels. 他谈论了他的旅行。"],
    usageNotes: [
  ...
  },
  {
    ...
    definition: "购买",
    wordRootMemory: "",
    examples: ["I encourage readers to go to their local library when they can't afford to purchase a book. 我鼓励读者在买不起书时去他们当地的图书馆。(2020年全国卷 2)", "He gave his son some money for the purchase of his school books. 他给儿子一些钱买课本。"],
    usageNotes: [
  ...
  },
  {
    ...
    wordRootMemory: "",
    examples: ["People should work harder to master computer use. 人们应该更努力地学习使用计算机。", "the master's degree 硕士学位", "She quickly mastered the new software. 她很快掌握了新软件。"],
    usageNotes: [
  ...
  {
    word: "object",
    pronunciation: "/ 'ɒbdʒɪkt / n. / əb'dʒekt / v.",
    partOfSpeech: "n./v.",
    definition: "n. 物体;目标;宾语 v. 反对",
    wordRootMemory: "词根记忆:ob(反)+ject(扔)→反向扔→反对",
    examples: ["He can draw without looking at the object he draws. 他不看实物就能把要画的东西画出来。(n.)", "Many people object to the new plan. 许多人反对这项新计划。(v.)"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["Millions of people will face starvation next year as a result of the flood. 由于洪水,数百万人明年将要面临挨饿的困境。", "Many animals died of starvation during the drought. 许多动物在干旱期间饿死了。"],
    usageNotes: [
  ...
  },
  {
    ...
    definition: "喜爱的,爱好的",
    wordRootMemory: "",
    examples: ["Tom is extremely fond of pointing out others' mistakes. 汤姆特别喜欢挑别人的毛病。", "She is fond of animals. 她喜欢动物。"],
    usageNotes: [
  ...
  },
  {
    ...
    definition: "全体职员",
    wordRootMemory: "",
    examples: ["the staff of a school 学校的教职员工", "All the staff were helpful. 所有的员工都很乐于助人。"],
    usageNotes: [
  ...
  },
  {
    ...
    wordRootMemory: "",
    examples: ["John asked his little boy to buy him a package of cigars in the near shop. 约翰叫他的小儿子在附近的商店给他买一包香烟。", "I received a package in the mail today. 我今天收到了一个邮寄的包裹。"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["I have always been honest and straightforward. 我一直都正直、坦率。", "The instructions were straightforward and easy to follow. 说明简单明了，易于遵守。"],
    usageNotes: [
  ...
  // Page 29
  {
    ...
    wordRootMemory: "",
    examples: ["I felt guilty about lying to you. 对你撒了谎,我感到很内疚。", "The jury found him guilty of murder. 陪审团判他犯有谋杀罪。"],
    usageNotes: [
  ...
  },
  {
    ...
    wordRootMemory: "",
    examples: ["physical exercise 体育锻炼", "If you exercise out of doors, your body will learn to breathe more deeply... (2019年全国卷 1)", "You should exercise regularly to stay healthy. 你应该经常锻炼以保持健康。"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["Antarctic explorers have many strange experiences there. 南极探险者在南极有很多奇怪的经历。", "Penguins live in the Antarctic. 企鹅生活在南极地区。"],
    usageNotes: [
  ...
  },
  {
    ...
    definition: "曾经;无论何时",
    wordRootMemory: "",
    examples: ["I would never ever come to this restaurant again. The food is terrible! 我以后再也不会来这家饭店了,饭菜太难吃了!", "Have you ever been to Japan? 你曾经去过日本吗?"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["While money is indeed wonderful and necessary, rereading an author's work is the highest currency a reader can pay them. (2020年全国卷 1)", "What is the currency used in Japan? 日本使用的货币是什么？"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["the Town Hall = the City Hall 市政厅", "There are three dining halls on campus. 校园里有三个食堂。", "We waited in the entrance hall. 我们在门厅等候。"],
    usageNotes: [
        "concert hall 音乐厅",
        "dining hall 餐厅",
        "entrance hall 门厅",
  ...
  },
  {
    ...
    examples: ["I'm innocent. 我是无辜的。", "He claims to be innocent of the crime. 他声称自己没有犯那项罪行。", "She has an innocent face. 她有一张天真无邪的脸。"],
    usageNotes: [
  ...
  // Page 30
  {
    ...
    definition: "停车",
    wordRootMemory: "",
    examples: ["All the parking spaces of this shopping mall were taken. 这个购物中心的停车位已经满了。", "Finding parking in the city center can be difficult. 在市中心找停车位可能很难。"],
    usageNotes: [
  ...
  },
  {
    ...
    definition: "垃圾;废物",
    wordRootMemory: "",
    examples: ["The corner of the room was littered with rubbish. 这间房间的角落里堆着垃圾。", "Please put the rubbish in the bin. 请把垃圾扔进垃圾桶。"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["A freeway runs through the village. 一条高速公路穿过那个村庄。", "Traffic on the freeway was heavy this morning. 今天早上高速公路上的交通很拥挤。"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["Tools are extensions of human hands. 工具是人类双手的延伸。", "We are building an extension to our house. 我们正在给房子加盖一部分。"],
    usageNotes: [
        "extension cord 延长线",
  ...
  },
  {
    ...
    wordRootMemory: "",
    examples: ["Now it's not reasonable to sell the new houses at a high price in some big cities. 目前,在一些大城市以高价卖新房是不合理的。", "She seems like a reasonable person. 她看起来像个通情达理的人。"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["Is Dr. Black available? I'd like to talk to him. 布莱克医生有空吗?我想跟他谈一谈。", "Lockers are available to store any belongings during your visit. (2017年全国卷1)", "Tickets are available online. 票可以在网上买到。"],
    usageNotes: [
  ...
  },
  {
    ...
    definition: "加,加上",
    wordRootMemory: "",
    examples: ["The cost is 20 yuan, plus 12 yuan for postage. 费用为20元,另加12元的邮费。", "Six plus two equals eight. 6加2等于8。", "The job requires experience, plus a willingness to travel. 这项工作需要经验，外加愿意出差。"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["He is an outstanding politician. 他是一名杰出的政治家。", "She has outstanding talent. 她有杰出的才能。"],
    usageNotes: [
  ...
  },
  {
    ...
    definition: "冠军,优胜者",
    wordRootMemory: "",
    examples: ["the boxing champion of the world 世界拳击冠军", "She is the reigning Olympic champion. 她是现任奥运冠军。"],
    usageNotes: [
        "world champion 世界冠军",
  ...
  // Page 31
  {
    ...
    definition: "实验",
    wordRootMemory: "",
    examples: ["The result of the experiment was very good. 实验的结果非常理想。", "Scientists are conducting experiments to test the theory. 科学家们正在进行实验来检验这个理论。"],
    usageNotes: [
  ...
  },
  {
    ...
    definition: "可能;能够;可以",
    wordRootMemory: "",
    examples: ["Can you drive a car? 你会开车吗?", "Can it be true? 这是真的吗?", "Today is Sunday. He can't be at school today. 今天是星期天,他不可能去上学。", "You can use my car. 你可以用我的车。"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["Keep the camera steady while you take a picture. 拍照时让相机保持平稳。", "The boat remained steady in the water. 船在水中保持平稳。"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["After years of heated debate, gray wolves were reintroduced... (2017年全国卷 3)", "Scientists were debating whether an asteroid was about to hit the Earth.", "They debated the issue for hours. 他们就这个问题辩论了好几个小时。"],
    usageNotes: [
        "heated debate 激烈的辩论",
        "public debate 公开辩论",
        "debate team 辩论队",
  ...
  },
  {
    ...
    wordRootMemory: "",
    examples: ["I ate a can of beans for supper. 晚饭我吃了一罐青豆。", "Throw the empty can in the recycling bin. 把空罐子扔到回收箱里。"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["It was apparent that he knew nothing about how to repair cars. 很明显,他对如何修理小汽车一无所知。", "The reason for his anger was not apparent. 他生气的原因不明显。"],
    usageNotes: [
  ...
  // Page 32
  {
    ...
    wordRootMemory: "",
    examples: ["Have you combed your hair? 你梳头了吗?", "She ran a comb through her hair. 她用梳子梳理了一下头发。"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["We should be optimistic about our future. 我们应该对自己的未来持乐观态度。", "Despite the difficulties, she remains optimistic. 尽管困难重重，她仍然保持乐观。"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["The handsome young man fell in love with the pretty girl at first sight.", "There is no one in sight.", "The Grand Canyon is an amazing sight. 大峡谷是令人惊叹的景象。"],
    usageNotes: [
  ...
  },
  {
    ...
    definition: "债务,欠款",
    wordRootMemory: "",
    examples: ["He is heavily in debt. 他负债累累。", "The company is trying to reduce its debt. 公司正试图减少债务。"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["Maths is an intrinsic part of the school curriculum. 数学是学校课程的固有组成部分。", "The university offers a broad curriculum. 这所大学提供广泛的课程。"],
    usageNotes: [
  ...
  },
  {
    ...
    examples: ["The angry boss shouted at his secretary to shut the window.", "Don't shout, I can hear you. 别喊，我能听见。"],
    usageNotes: [
